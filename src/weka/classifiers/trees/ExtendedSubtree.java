...
public class ExtendedSubtree extends AbstractClassifier implements OptionHandler,
  Randomizable, WeightedInstancesHandler, AdditionalMeasureProducer,
  TechnicalInformationHandler, PartitionGenerator, Aggregateable<ExtendedSubtree> {

  /** for serialization */
  static final long serialVersionUID = 1116839470751428698L;

  /** Number of trees in ExtendedSubtree. */
  ...
  protected boolean m_printTrees = true;
  ...
  public String globalInfo() {
    ...
    return "Class for constructing a ExtendedSubtree of random trees.\n\n"
  ...
  /**
   * Gets the current settings of the ExtendedSubtree.
   * 
  ...
  public Capabilities getCapabilities() {
    return new RandomSubTree().getCapabilities();
  }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    // RandomSubTree implements WeightedInstancesHandler, so we can
    // represent copies using weights to achieve speed-up.
    m_bagger.setRepresentCopiesUsingWeights(true);

    RandomSubTree rTree = new RandomSubTree();
    ...
    // set up the bagger and build the ExtendedSubtree
   ...
   * @return the distribution the ExtendedSubtree generates for the instance
  ...
  public String toString() {
    ...
    if (m_bagger == null) {
      return "Random ExtendedSubtree not built yet";
    } else {
      StringBuffer temp = new StringBuffer();
      temp.append("Random ExtendedSubtree of "
        + m_numTrees
  ...
  public static void main(String[] argv) {
    runClassifier(new ExtendedSubtree(), argv);
  }

  @Override
  public ExtendedSubtree aggregate(ExtendedSubtree toAggregate) throws Exception {
