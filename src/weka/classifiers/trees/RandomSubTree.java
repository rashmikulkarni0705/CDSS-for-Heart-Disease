 ...
 */
public class RandomSubTree extends AbstractClassifier implements OptionHandler,
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (data.classAttribute().isNumeric()) {
      trainVariance = RandomSubTree.singleVariance(classProbs[0], totalSumSquared,
  ...
  protected class Tree implements Serializable {
    ...
    public void backfitData(Instances data) throws Exception {
      ...
      double trainVariance = 0;
      if (data.classAttribute().isNumeric()) {
        trainVariance = RandomSubTree.singleVariance(classProbs[0],
    ...
    protected void backfitData(Instances data, double[] classProbs,
      ...
      if (data.classAttribute().isNumeric()) {
        ...
        priorVar = RandomSubTree.singleVariance(totalSum, totalSumSquared,
          totalSumOfWeights);
      }
      ...
      if (attribute.isNominal()) {
        ...
        for (int i = 0; i < indexOfFirstMissingValue; i++) {
          ...
          if (inst.value(att) > currSplit) {
            currVal = RandomSubTree.variance(currSums, currSumSquared,
              currSumOfWeights);
            if (currVal < bestVal) {
              bestVal = currVal;
  ...
  public static void main(String[] argv) {
    runClassifier(new RandomSubTree(), argv);
  }
}
